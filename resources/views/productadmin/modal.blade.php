                    ...
                    <form class="form-horizontal" action="discount" method="POST">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control  select2 select2-hidden-accessible" name="undangan_id" style="width: 100%;"
                                        data-select2-id="1" tabindex="-1" aria-hidden="true">
                                        @foreach ($product as $select)
                                            <option value="{{ $select->id }}">{{ $select->nama }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="Number" name="discount" class="form-control" id="inputPassword3" placeholder="0%">
                                </div>
                            </div>
                            <div class="form-group row">
