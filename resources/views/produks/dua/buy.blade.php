...
<head>
    ...
    <meta name="title" content="Website Undang  an Pernikahan Wahyu dan Riski Secara Online" />
    ...
    <link rel="apple-touch-icon" sizes="192x192" type="image/png"
        href="https://ulems.my.id/assets/images/icon-192x192.png" />
    ...
    <link rel="preload" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css"
        integrity="sha256-MBffSnbbXwHCuZtgPYiwMQbfE7z+GOZ7fBPCNB06Z98=" crossorigin="anonymous" as="style" />
    <link rel="preload"
        href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.5.0/css/all.min.css"
        integrity="sha256-yIDrPSXHZdOZhAqiBP7CKzIwMQmRCJ8UeB8Jo17YC4o=" crossorigin="anonymous" as="style" />
    ...
    <link rel="preload" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"
        integrity="sha256-gvZPYrsDwbwYJLD5yeBfcNujPhRoGOY831wwbIzz3t0=" crossorigin="anonymous" as="script" />
    ...
    <link rel="preload"
        href="https://cdn.jsdelivr.net/npm/tsparticles-confetti@2.12.0/tsparticles.confetti.bundle.min.js"
        integrity="sha256-XG5M9shcLLpu8ct5bVbu6lLVzLpfZChl+csxdyLVP18=" crossorigin="anonymous" as="script" />
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.5.0/css/all.min.css"
        integrity="sha256-yIDrPSXHZdOZhAqiBP7CKzIwMQmRCJ8UeB8Jo17YC4o=" crossorigin="anonymous" />
    ...
    <!-- App -->
    <link rel="stylesheet" href="{{ asset('produk2') }}/css/app.css" />
    <script src="{{ asset('produk2') }}/js/app.js" defer></script>
    <style>
        .fixed-button {
            position: fixed;
            right: 40px;
        ...
        .content {
            /* Pastikan konten di dalam div ini memiliki padding di sisi kanan agar tidak tertutup oleh tombol */
            padding-right: 150px;
            /* Sesuaikan dengan lebar tombol + jarak dari sisi kanan */
        }
    </style>
</head>
...
<body data-email="user@example.com" data-password="12345678" data-url="https://api.ulems.my.id/"
    ...
    <main class="text-light" data-bs-spy="scroll" data-bs-target="#navbar-menus" data-bs-root-margin="0px 0px -40%"
            ...
            <div class="text-center pt-4">
                ...
                <div class="py-4">
                    <div class="img-crop border border-3 border-light shadow mx-auto">
                        <img src="{{ route('image.display', $foto2) }}" alt="bg"
                            onclick="util.modal(this)" />
                    </div>
                </div>

                <h1 class="font-esthetic my-4" style="font-size: 3rem">
                    {{ $data->pengantin_l }} & {{ $data->pengantin_p }}
                </h1>
              ...
              {{ $tanggal }}
                ...
                <a class="btn btn-outline-light btn-sm shadow rounded-pill px-3 my-2" target="_blank"
                    ...
                    <i class="fa-solid fa-calendar-check me-2"></i>Save The
                    Date
                </a>
            ...
            <div class="text-center">
                ...
                <div class="overflow-x-hidden">
                    <div data-aos="fade-right" data-aos-duration="2000">
                        ...
                        <p class="mt-3 mb-0" style="font-size: 1.25rem">
                            Putra
                        </p>
                        <p class="mb-0">{{ $data->ortu_l }}</p>
                    </div>
                    ...
                    <div class="position-relative">
                        <div class="position-absolute" style="top: 0%; right: 10%">
                            <svg xmlns="https://www.w3.org/2000/svg" width="48" height="48"
                                ...
                                onload="util.animate(this, 3000, 'animate-love')" viewBox="0 0 16 16">
                                <path
                                    d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15" />
                            </svg>
                        </div>
                    ...
                    <h1 class="font-esthetic my-4" style="font-size: 4rem">
                        &
                    </h1>
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <div class="border rounded-pill shadow py-2 px-4 mx-2 mb-4">
                        ...
                        <div class="row justify-content-center" data-waktu="{{ $data->tanggal }} 00:00:00" id="tampilan-waktu">
                            <div class="col-3 p-1">
                    ...
                    <p style="font-size: 0.9rem" class="mt-4 py-2">
                        ...
                        Ta'ala, insyaAllah kami akan menyelenggarakan acara
                        :
                    </p>
                    ...
                    <div class="overflow-x-hidden">
                        <div class="py-2" data-aos="fade-right" data-aos-duration="1500">
                            <h1 class="font-esthetic" style="font-size: 2rem">
                                Akad
                            </h1>
                    ...
                    <div class="py-2" data-aos="fade-up" data-aos-duration="1500">
                        <a href="{{ url($data->linkGmaps) }}" target="_blank"
        ...
        type="button" data-bs-target="#carousel-foto-satu" data-bs-slide="prev">
    ...
    <div id="carousel-foto-dua" data-aos="fade-up" data-aos-duration="1500" class="carousel slide mt-4"
        data-bs-ride="carousel">
        <div class="carousel-indicators">
            <button type="button" data-bs-target="#carousel-foto-dua" data-bs-slide-to="0" class="active"
        ...
        <div class="carousel-inner rounded-4">
            @for ($i = count($album) - 1; $i >= count($album) - 3 && $i >= 0; $i--)
                <div class="carousel-item @if ($i === count($album) - 1) active @endif">
                    <img src="{{ route('image.display', $album[$i]->foto) }}" alt="gambar {{ count($album) - $i }}"
                        class="d-block w-100" onclick="util.modal(this)" />
                </div>
            @endfor
        </div>
                ...
                <div class="overflow-x-hidden">
                    <div class="row justify-content-center">
                        <div class="col-5 card-body border rounded-4 shadow p-3 m-3" data-aos="fade-down"
                            ...
                            <button class="btn btn-light btn-sm rounded-3" data-nomer="{{ $rekening1 }}"
                                onclick="util.salin(this)" autofocus>
                                Salin No. Rekening
                            </button>
                        </div>
                        ...
                        <div class="col-5 card-body border rounded-4 shadow p-3 m-3" data-aos="fade-down"
                            ...
                            <!-- Ubah juga data-nomer sesuai dengan no rekening -->
                            <button class="btn btn-light btn-sm rounded-3" data-nomer="{{ $rekening2 }}"
                                onclick="util.salin(this)" autofocus>
                                Salin No. Rekening
                            </button>
                        </div>
    ...
    <section class="m-0 p-0" id="ucapan">
        <div class="container">
            <form action="{{ url('ucapanpdua') }}" method="POST">
                ...
                <div class="card-body border rounded-4 shadow p-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control shadow-sm" name="ucapan" id="form-pesan" rows="4"
            ...
            <div class="container rounded pb-2 my-5 border">
                <h1 class="p-1 font-esthetic">ucapan</h1>
                <p class="blockquote-footer mt-1">Komen {{ $totalucapan }}</p>
                @foreach ($ucapan as $ucapan)
                    <div class="card mt-3 bg-dark px-5">
                        <div class="card-body">
                            <blockquote class="blockquote mb-0">
                                <p>{{ $ucapan->ucapan }}</p>
                                <p class="blockquote-footer">{{ $ucapan->nama }}</p>
                            </blockquote>
                        </div>
                    </div>
                @endforeach
                ...
                <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                    ...
                    <div class="col-auto">
                        <small>
                            ...
                            <i class="fa-brands fa-youtube me-1"></i><a target="_blank"
                                href="https://www.youtube.com/watch?v=1WCIrw85zbQ">I Wanna Grow Old with You</a>
                        </small>
                    </div>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-center align-items-center" style="height: 100vh !important">
            <div class="text-center">
                ...
                <button type="button" class="btn btn-light shadow rounded-4 mt-4" onclick="util.buka(this)">
                    <i class="fa-solid fa-envelope-open me-2"></i>Buka
                    Undangan
                </button>

                @if ($data->status == 'edit')
                    <a href="{{ url('profile/' . auth()->user()->id) }}" class="fixed-button">Bayar untuk publis</a>
                @endif
    ...
    <button type="button" id="tombol-musik" style="display: none"
        class="btn btn-light btn-sm rounded-circle btn-music" onclick="util.music(this)" data-status="true"
        data-url="{{ asset('produk2') }}/assets/music/sound.mp3">
    ...
    <div class="loading-page" id="loading" style="opacity: 1">
        <div class="d-flex justify-content-center align-items-center" style="height: 100vh !important">
            <div class="text-center w-75">
                <img class="img-fluid mb-3" src="{{ asset('produk2') }}/assets/images/icon-192x192.png"
                    alt="icon" style="width: 3.5rem" />
                <div class="progress" role="progressbar" style="height: 0.5rem">
                    <div class="progress-bar" id="bar" style="width: 0%"></div>
                </div>
                <small class="mt-1 text-light" id="progress-info" style="display: none">Loading assets</small>
            ...
            <div class="modal-content">
                <div class="modal-body p-0">
                    <div class="d-flex justify-content-center align-items-center" style="height: 100%">
                        <img src="{{ asset('produk2') }}/assets/images/bg.jpeg" class="w-100" alt="foto"
                            id="show-modal-image" />
                    </div>
                </div>
            </div>
