...
<head>
    ...
    <link rel="preload" href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.5.0/css/all.min.css"
                ...
                <div class="overflow-x-hidden">
                    <div data-aos="fade-right" data-aos-duration="2000">
                        <div class="img-crop border border-3 border-light shadow my-4 mx-auto">
                            <img src="{{ asset('produk2') }}/assets/images/cowo.png" alt="cowo"
                                onclick="util.modal(this)" />
                        </div>
                    ...
                    <div data-aos="fade-left" data-aos-duration="2000">
                        <div class="img-crop border border-3 border-light shadow my-4 mx-auto">
                            <img src="{{ asset('produk2') }}/assets/images/cewe.png" alt="cewe"
                                onclick="util.modal(this)" />
                        </div>
                        <h1 class="font-esthetic" style="font-size: 3rem">
                            Riski Siapa
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <div class="border rounded-pill shadow py-2 px-4 mx-2 mb-4">
                        ...
                        <div class="row justify-content-center" data-waktu="2024-03-01 00:00:00" id="tampilan-waktu">
                            <div class="col-3 p-1">
                    ...
                    <div class="py-2" data-aos="fade-up" data-aos-duration="1500">
                        ...
                        <p class="mb-0 mt-1 mx-1 pb-4" style="font-size: 0.9rem">
                            RT 10 RW 02, Desa Pajerukan, Kec. Kalibagor,
                            Kab. Banyumas, Jawa Tengah 53191
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="dark-section" id="galeri">
            <div class="container pb-2 pt-4">
                <div class="card-body border rounded-4 shadow p-3">
                    ...
                    <div id="carousel-foto-satu" data-aos="fade-up" data-aos-duration="1500" class="carousel slide"
                        ...
                        <div class="carousel-inner rounded-4">
                            <div class="carousel-item active">
                                <img src="https://picsum.photos/1280/720?random=1" alt="gambar 1"
                                    class="d-block w-100" onclick="util.modal(this)" />
                            </div>
                            <div class="carousel-item">
                                <img src="https://picsum.photos/1280/720?random=2" alt="gambar 2"
                                    class="d-block w-100" onclick="util.modal(this)" />
                            </div>
                            <div class="carousel-item">
                                <img src="https://picsum.photos/1280/720?random=3" alt="gambar 3"
                                    class="d-block w-100" onclick="util.modal(this)" />
                            </div>
                        </div>
                    ...
                    <div id="carousel-foto-dua" data-aos="fade-up" data-aos-duration="1500"
                        ...
                        <div class="carousel-inner rounded-4">
                            <div class="carousel-item active">
                                <img src="https://picsum.photos/1280/720?random=4" alt="gambar 4"
                                    class="d-block w-100" onclick="util.modal(this)" />
                            </div>
                            <div class="carousel-item">
                                <img src="https://picsum.photos/1280/720?random=5" alt="gambar 5"
                                    class="d-block w-100" onclick="util.modal(this)" />
                            </div>
                            <div class="carousel-item">
                                <img src="https://picsum.photos/1280/720?random=6" alt="gambar 6"
                                    class="d-block w-100" onclick="util.modal(this)" />
                            </div>
                        </div>
                ...
                <div class="card-body border rounded-4 shadow p-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="alertDiv" class="alert alert-info alert-dismissible fade show" role="alert">
                            ...
                            <p class="m-0">
                                Sekarang bisa format text seperti whatsapp
                                lohh... cobainn sekaranggg, makaciwww
                                bestieee
                            </p>
