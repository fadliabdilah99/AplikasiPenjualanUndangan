@foreach ($produk as $prod)
    <!-- Modal -->
    <div class="modal fade" id="buy{{ $prod->link }}" tabindex="-1" aria-labelledby="buyLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="edit{{ $prod->link }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if (Auth::check())
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" name="rekenin1" class="form-control"
                                        id="exampleInputEmail1" placeholder="Nama Pengantin">
                                </div>
                                <div class="form-group col-6">
                                    <label for="exampleInputEmail1">Rekening 2</label>
                                    <input type="text" name="rekening2" class="form-control"
                                        id="exampleInputEmail1" placeholder="Nama Pengantin">
                                </div>
                            </div>
                            <div class="row">
